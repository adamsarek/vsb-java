...
//== NOVĚ ZAVEDENÉ METODY INSTANCÍ =============================================
  ...
  public void fillTriangle(double xPos,double  yPos,int width,int height,MyColor color){
    g.setStroke(color.getColor());
    g.setFill(color.getColor());
    g.strokeLine(xPos+width/2, yPos,xPos+width, yPos+height);
    g.strokeLine(xPos+width, yPos+height,xPos, yPos+height);
    g.strokeLine(xPos, yPos+height, xPos+width/2, yPos);
