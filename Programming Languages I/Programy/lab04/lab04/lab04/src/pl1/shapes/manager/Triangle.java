...
import pl1.lab07.GetValuable;
import pl1.lab07.Valuable;
 ...
 * @version 3.00.002
 */
public class Triangle implements Valuable, GetValuable, Paintable {
...
//    double[][] points = getVertices();
    g.fillTriangle(xPos,yPos,width,height,color);
